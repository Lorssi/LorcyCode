...
from lorcy_code.cli.ui.display import render_tool_call, console, Text
from lorcy_code.core.tools.shell.session import ShellSession
from lorcy_code.core.tools.shell.provider import BashProvider, PowerShellProvider
from lorcy_code.core.tools.shell.semantics import interpret_command_result
from lorcy_code.core.tools.config import (
    _GREP_MAX_FILE_SIZE, 
    _GREP_EXCLUDED_DIRS, 
    _GREP_BINARY_EXT, 
    _STATUS_MARKERS,
...
async def agent(
    ...
    from lorcy_code.core.agent.loader import load_agents
    from lorcy_code.core.agent.runner import run_subagent
